  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 py-32 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full max-w-[480px] bg-white rounded-[2.5rem] shadow-2xl shadow-primary/5 border border-outline-variant p-8 md:p-12 relative z-10"
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-heading font-extrabold text-primary mb-3">Welcome Back</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center gap-2 px-1">
            ...
            <label htmlFor="remember" className="text-xs text-on-surface-variant font-medium">Remember me for 30 days</label>
          </div>
        ...
        <div className="relative my-10 text-center">
          ...
          <span className="relative px-4 bg-white text-xs font-bold text-on-surface-variant uppercase tracking-widest">Or continue with</span>
        </div>

        <div className="grid grid-cols-2 gap-4">
          <button className="flex items-center justify-center gap-3 py-3 px-4 border border-outline-variant rounded-2xl font-bold text-sm text-primary hover:bg-surface-container-low transition-colors active:scale-95">
            <GoogleIcon />
            <span>Google</span>
          </button>
          <button className="flex items-center justify-center gap-3 py-3 px-4 border border-outline-variant rounded-2xl font-bold text-sm text-primary hover:bg-surface-container-low transition-colors active:scale-95">
        ...
        <p className="mt-10 text-center text-sm text-on-surface-variant">
          Don't have an account? <Link href="/register" className="text-secondary font-bold hover:underline">Create an account</Link>
        </p>
      </motion.div>

      {/* Benefits section for large screens */}
      <div className="hidden lg:flex flex-col gap-8 fixed left-12 top-1/2 -translate-y-1/2 max-w-xs">
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 rounded-2xl bg-primary/10 flex items-center justify-center shrink-0">
            <CheckCircle2 className="w-5 h-5 text-primary" />
          </div>
          <div>
            <h4 className="font-bold text-primary mb-1">Exclusive Offers</h4>
            <p className="text-xs text-on-surface-variant leading-relaxed">Get access to member-only discounts and early product launches.</p>
          </div>
        </div>
        <div className="flex items-start gap-4">
          ...
          <div>
            <h4 className="font-bold text-primary mb-1">Order Tracking</h4>
            <p className="text-xs text-on-surface-variant leading-relaxed">Track your wellness shipments in real-time from your dashboard.</p>
          </div>
        </div>
        <div className="flex items-start gap-4">
          ...
          <div>
            <h4 className="font-bold text-primary mb-1">Health Journal</h4>
            <p className="text-xs text-on-surface-variant leading-relaxed">Keep track of your supplement routine and health progress.</p>
          </div>
        </div>
      </div>
    </div>
